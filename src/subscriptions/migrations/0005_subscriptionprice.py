...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('subscriptions', '0004_subscription_stripe_product_id'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='eur', max_length=120)),
                ('unit_amount', models.DecimalField(decimal_places=2, default=99.99, max_digits=10)),
